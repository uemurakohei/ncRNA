library(openxlsx)
setwd("/Users/uemurakohei/Desktop/paper3/lncRNA/avg_profile/divergent_p_lncRNA")
...
lncRNA_id <- read.table("/Users/uemurakohei/Desktop/paper3/lncRNA/divergent_p_lncRNA/FANTOM_CAT.lv3_robust.only_divergent_p_lncRNA.bed")
