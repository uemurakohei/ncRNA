library(openxlsx)
setwd("/Users/uemurakohei/Desktop/paper3/lncRNA/avg_profile/intergenic_p_lncRNA")
...
lncRNA_id <- read.table("/Users/uemurakohei/Desktop/paper3/lncRNA/intergenic_p_lncRNA/FANTOM_CAT.lv3_robust.only_intergenic_p_lncRNA.bed")
